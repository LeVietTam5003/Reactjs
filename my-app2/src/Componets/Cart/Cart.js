        ...
        return data.map((value,key)=>{
            ...
            return(
                <tbody>
                    <tr>
                        <td>
                            <img className="image_product" src={"http://localhost/laravel/public/upload/user/product/" + value.id_user +"/" + (JSON.parse(value.image))[0]} alt="" /> 
                        </td>
                        ...
                        <td>
                            <button onClick={clickDelete} id={value.id} className="cart_quantity_delete">
                                X
                            </button>
                        </td>
                    </tr>
...
function clickDelete(e){
    ...
    // tao 1 ban sao moi 
    let newDataDelete = [...data]; 
    
    // Anh Bảo
    // delete newDataDelete[getId]  
    // console.log(newDataDelete)  
    // setData(newDataDelete)

    newDataDelete.map((value,key)=>{
        if(getId == value.id){
           delete newDataDelete[key]  
        }
    })  
    //------------ xóa empty ------------//
    newDataDelete = newDataDelete.filter(n => n)
    //------------ xóa empty ------------//
    setData(newDataDelete)
            ...
            <div className="container">
                ...
                <div className="col-sm-6">
                    ...
                    <ul>
                        ...
                        <li>
                        ${rederTotal()}<span className="total1" />
                        </li>
                    </ul>
                    <Link className="btn btn-default update" to="">
                        Update
